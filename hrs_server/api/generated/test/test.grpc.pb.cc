...
static const char* TestService_method_names[] = {
  "/TestApi.TestService/ExecuteTestRequest1",
  "/TestApi.TestService/ExecuteTestRequest2",
};
...
TestService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  : channel_(channel), rpcmethod_ExecuteTestRequest1_(TestService_method_names[0], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
